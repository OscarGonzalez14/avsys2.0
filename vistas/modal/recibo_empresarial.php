...
<!-- Modal -->
<div id="detalle_abonos_empresarial" class="modal fade" role="dialog">
  <div class="modal-dialog" id="tamModal">
    ...
    <div class="modal-content">
      <div class="modal-header" id="head"><div id="valida_rec"></div>
        ...
        <h5 class="modal-title" align="center"><i class="fa fa-usd" aria-hidden="true"></i> ABONO EMPRESARIAL</h5>
      </div>
     ...
     <!--Tabla generalidades del paciente-->
      <table  class="table table-striped table-bordered table-condensed table-hover">
        <thead>
          <tr>
            <th><p align="center">No. Ventas</p></th>
