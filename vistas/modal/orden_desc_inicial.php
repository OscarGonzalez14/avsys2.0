...
<div class="col-xs-2">
  ...
  <!--***************DATOS DEL BENEFICIARIO-->
      <div class="col-xs-4">
        ...
        <input class="form-control" id="pac_beneficiario" name="pac_beneficiario" type="text" required" placeholder="Nombre del beneficiario" data-toggle="modal" data-target="#beneficiarios_venta" readonly>
      </div>
            <div class="col-xs-3">
        ...
        <input class="form-control" id="direccion_parentesco" name="direccion_parentesco" type="text" placeholder="">
      </div>
...
<!--***********DATOS JEFE INMEDIATO-->
    <div class="col-xs-5">
      ...
      <input class="form-control" id="jefe_inmediato" type="text" name="jefe_inmediato" placeholder="TELEFONO REF. 2" required>
    </div>
    ...
    <div class="col-xs-4">
      ...
      <input class="form-control" id="cargo_jefe_inmediato" type="text" name="cargo_jefe_inmediato" placeholder="Cargo Jefe Inmediato" required>
    </div>  
